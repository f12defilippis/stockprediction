...
public class Parameter implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -546270641636693568L;
    ...
    /**
     * Compares the key for this instance with another Parameter.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class Parameter and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another Parameter.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        ...
        return this.equalKeys(other) && ((Parameter)other).equalKeys(this);
    }
